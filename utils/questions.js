const questions = [
  // ===== 第一部分：焦虑依恋维度（12题）=====
  // 计分规则：A=1分, B=2分, C=3分, D=4分。得分越高，焦虑倾向越明显。
  {
    id: 1,
    ...
    options: [
      ...
      { label: "C", text: "会忍不住想"TA是不是厌烦我了"，并反复看手机", score: 3 },
      { label: "D", text: "极度恐慌，甚至开始脑补"TA是不是出事了/出轨了"的剧情", score: 4 }
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: [
      ...
      { label: "B", text: ""是不是我不够好/不值得被爱？"", score: 2 },
  ...
  // ===== 第二部分：回避依恋维度（12题）=====
  // 计分规则：A=4分, B=3分, C=2分, D=1分。得分越高，回避倾向越明显。
  {
    id: 13,
    text: "当遇到棘手难题时，你的第一反应更倾向于：",
    dimension: "avoidant",
    options: [
      { label: "A", text: "立刻自己查资料/解决，不到万不得已不求助", score: 4 },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "C", text: "努力说出口，但会有点脸红/不自然", score: 2 },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "B", text: "有点烦躁，觉得"翻旧账"没必要", score: 3 },
